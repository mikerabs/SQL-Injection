...
*You might have to run the command "mkdir output" in the root directory because of my .gitignore so the DatabaseQueryTool class has a valid path to write to
